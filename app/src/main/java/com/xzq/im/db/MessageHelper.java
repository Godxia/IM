...
public class MessageHelper {
     ...
     * @return
     */
    private UsersInfomation GetUser(String userName) {
        UsersInfomation user = null;
        ...
        if (cursor.moveToNext()) {
            ...
            user = new UsersInfomation(user_id, user_name, user_psd, user_head_img);
        }
        return user;
    }
     ...
     * @return
     */
    public UsersInfomation SetUser(String userName, String userPsd) {
        UsersInfomation user = GetUser(userName);
        if (user == null) {
